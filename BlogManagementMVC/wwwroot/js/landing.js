...
function doAnimations(elems) {
  ...
  if ($('.landing-projects-carousel')) {
    $('.landing-projects-carousel').slick({
      slidesToShow: 1.5,
      infinite: false,
      prevArrow: '<button type="button" class="slick-nav-btn"><img src="~/images/Arrow_L@2x.svg"></button>',
      nextArrow: '<button type="button" class="slick-nav-btn"><img src="~/images/Arrow_R@2x.svg"></button>',
